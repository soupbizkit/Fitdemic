...
public final class UtilitiesDataBase {
    ...
    public class TablaUsuarios{
        ...
        static final String CREATE_TABLE_USUARIOS="CREATE TABLE "+ TABLE_NAME+"("+ID+ " INTEGER PRIMARY KEY AUTOINCREMENT, "+NOMBRE+" TEXT, "+EDAD+" INTEGER NOT NULL, "+ PESO+" INTEGER NOT NULL, "+SEXO+" TEXT, "+ PADECIMIENTOS + " TEXT);";
